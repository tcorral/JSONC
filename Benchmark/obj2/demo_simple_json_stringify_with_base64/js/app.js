...
$("form").submit(function(event)
{
  ...
  sObj = JSON.stringify( obj2 );
  nLenObjStr = sObj.length;
  sZipped = JSONC.pack( obj2, true );
  ...
  $.ajax({
    url: "/obj2/demo_simple_json_stringify_with_base64/alo.php",
    type: "POST",
    data: { json: Base64.encode(sObj) },//nLenObjStr > nLenZipped ? sZipped : sObj },
    dataType: 'json',
